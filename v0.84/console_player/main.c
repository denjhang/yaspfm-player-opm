...
void save_configuration(int dev_idx, const char* slot0, const char* slot1, double speed, int flush_mode, int timer_mode);
            ...
            switch (c) {
                ...
                case '+': 
                    ...
                    // Quick save on change
                    {
                        ...
                        save_configuration(spfm_get_selected_device_index(), s0, s1, g_speed_multiplier, g_flush_mode, g_timer_mode);
                    }
                    break;
                case '-': 
                    g_speed_multiplier -= 0.01; 
                ...
                case '3': g_timer_mode = 0; g_ui_refresh_request = true; break;
                case '4': g_timer_mode = 1; g_ui_refresh_request = true; break;
                case '5': g_timer_mode = 2; g_ui_refresh_request = true; break;
                case '6': g_timer_mode = 3; g_ui_refresh_request = true; break;
                case '7': g_timer_mode = 4; g_ui_refresh_request = true; break;
                case '8': g_timer_mode = 5; g_ui_refresh_request = true; break;
                case '9': g_timer_mode = 6; g_ui_refresh_request = true; break;
            }
            if(g_ui_refresh_request) {
                update_ui(0, g_current_song_total_samples, g_current_song_name, g_is_paused, g_random_mode);
                save_configuration(spfm_get_selected_device_index(), "NONE", "NONE", g_speed_multiplier, g_flush_mode, g_timer_mode);
...
int main(int argc, char *argv[]) {
    ...
    save_configuration(selected_dev_idx, slot0_name, slot1_name, g_speed_multiplier, g_flush_mode, g_timer_mode);
    ...
    while (!g_quit_flag) {
        ...
        g_current_song_total_samples = 0; // Reset after song finishes
